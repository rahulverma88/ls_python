...
def odeCFL2(data, tSpan, rhsFunc, grid, rhsData, options):
    ...
    while t < tSpan[1]:
        ...
        rhs, stepBound = rhsFunc(data_n_plus_1, grid, rhsData)
...
def odeCFL3(data, tSpan, rhsFunc, grid, rhsData, options):
    ...
    while t < tSpan[1]:
        ...
        rhs, stepBound = rhsFunc(data_n_plus_half, grid, rhsData)
        deltaT_int = min(options.factorCFL * stepBound, tSpan[1] - t, options.maxStep)
